<template>
  <div class="table-bg">
    <el-table :data="specslist">
      <el-table-column prop="id" label="ID" width="120px" align="center"></el-table-column>
      <el-table-column header-align="center" align="center" prop="specsname" label="规格名称"></el-table-column>
      <el-table-column header-align="center" align="center" label="规格值">
